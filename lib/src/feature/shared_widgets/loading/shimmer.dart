...
const _shimmerGradient = LinearGradient(
  colors: [Color(0xFFDCDCE3), Color(0xFFF4F4F4), Color(0xFFDCDCE3)],
  stops: [0.1, 0.3, 0.4],
  begin: Alignment(-1, -0.3),
  end: Alignment(1, 0.3),
);

class const Shimmer({required final Widget child, final LinearGradient linearGradient = _shimmerGradient, super.key})
