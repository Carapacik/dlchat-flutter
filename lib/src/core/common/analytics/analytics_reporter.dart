...
/// {@endtemplate}
@immutable
base class const AnalyticsEvent(
  ...
  /// data with the event.
  final Set<AnalyticsParameter<Object>> parameters = const {},
}) {
...
/// {@endtemplate}
@immutable
sealed class const AnalyticsParameter<T>(
...
/// {@endtemplate}
final class const StringAnalyticsParameter(super.name, super.value) extends AnalyticsParameter<String> {
...
/// {@endtemplate}
final class const NumberAnalyticsParameter(super.name, super.value) extends AnalyticsParameter<num> {
